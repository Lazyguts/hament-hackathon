          ...
          <main className="lg:col-span-2 space-y-12">
            <section>
              ...
              <ul className="space-y-3 list-disc list-inside text-slate-300">
                <li>
                  She has 11 years of college teaching experience along with 10
                  years as independent psychologist.
                </li>
                <li>
                ...
                <li>
                  Founder and counselling psychologist at RISE Clinic, Patiala.
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-slate-300 leading-relaxed">
                A passionate psychologist and experienced trainer, her expertise
                include soft skill, transaction analysis, emotional regulation,
                work life balance. She conducts workshops, seminars and faculty
                development programme for parents, teachers and students at
                various institutes. She is expert in diagnosing, handling and
                counselling to provide mental health support to client's
